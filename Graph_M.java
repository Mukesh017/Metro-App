...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void main(String[] args) throws IOException
		{
			...
			while(true)
			{
				...
				case 4:
					...
					System.out.println("SHORTEST TIME FROM ("+sat1+") TO ("+sat2+") IS "+g.dijkstra(sat1, sat2, true, processed1)/60+" MINUTES\n\n");
					break;
		...
		private int dijkstra(String sat1, String sat2, boolean b, HashMap<String, Boolean> processed1) {
